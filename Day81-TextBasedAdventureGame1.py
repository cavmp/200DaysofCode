...
def painful_truth_of_reality_room():
    print_monster()
    print("There you see the great evil guard.")
...
def get_player_name():
    ...
    answer = input("Your name is {}, is that correct? [Y|N] > ".format(name.upper()))
    if answer.lower() in ["y", "yes"]:
        ...
        print("Trying to be funny? Well, you will now be called {} anyway.".format(name.upper()))
    return name
...
def start_adventure():
    ...
    if door_picked == "red":
        ...
        print("Sorry, it's either 'red' or 'blue' as the answer. Goodbye!")
