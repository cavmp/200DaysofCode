...
def main():
    ...
    To get this to work in your own computer, change the 
    words in parantheses and change to your desired picture
    by putting ('the folder of the image here/ the name of the file')
    """
