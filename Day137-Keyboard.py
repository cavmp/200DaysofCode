...
for button in keys:
    if button != "SPACE":
        but = tk.Button(Keyboard_App, text=button, width=5, bg="#000000", fg="black", highlightthickness=4,
    ...
    if button == "SPACE":
        but = tk.Button(Keyboard_App, text=button, width=60, bg="#000000", fg="black", highlightthickness=4,
